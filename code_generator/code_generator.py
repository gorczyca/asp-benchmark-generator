...
def __generate_hierarchy_code(model: Model) -> str:
    """Generates hierarchy of components' code.

    :param model: Model
    :return: Hierarchy of components' code.
    """
    hierarchy_code = ''
...
def __generate_hierarchy_ontology_definitions():
    """Generates ontology definitions regarding hierarchy of components.
    (Ontology definitions are the same for every instance of configuration problem.)

    :return: Ontology definitions of hierarchy.
    """
